...
import { AnimatedLink } from '@/components/ui/line-animation'
...
export default function Footer() {
    return (
        <footer className="border-b bg-foreground pt-8 sm:pt-12 lg:pt-16 ">
                        ...
                        {links.map((link, index) => (
                            <div
                                ...
                                <ul className="space-y-2 sm:space-y-3 text-muted-foreground">
                                    {link.items.map((item) => (
                                        <li key={item.title}>
                                            <AnimatedLink href={item.href} className="text-white/70 hover:text-white transition-colors duration-200 text-xs sm:text-sm">
                                                {item.title}
                                            </AnimatedLink>
                                        </li>
                                    ))}
