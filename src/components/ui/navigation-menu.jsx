...
const navigationMenuTriggerStyle = cva(
  'cursor-pointer group inline-flex w-max items-center justify-center disabled:pointer-events-none disabled:opacity-50 px-2 sm:px-4 py-2 rounded-lg hover:bg-white/20 transition-colors duration-300 font-medium text-sm sm:text-base'
);
