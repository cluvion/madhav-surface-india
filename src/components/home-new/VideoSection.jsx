...
export default function VideoSection() {
    return (
        <section className="mt-8 md:mt-12 lg:mt-14 bg-black ">
            ...
            <div className="relative">
                ...
                <h2 className="z-1 absolute inset-0 top-5 md:top-0 text-center select-none text-[14vw] font-bold bg-gradient-to-b from-white/60 via-black to-black/60 bg-clip-text text-transparent">
                    Marble & Tiles
                </h2>
                ...
                <div className="z-10 absolute top-0 bottom-0 left-0 right-0 mt-12 md:mt-32">
                    <Video />
                </div>
            </div>
        </section>
