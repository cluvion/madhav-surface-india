            ...
            <div className="container relative z-10 mx-auto px-4 md:px-6">
                <div className="grid grid-cols-1 gap-12 text-center md:grid-cols-3">
                    <div className="border-r border-white/20 last:border-0 md:px-12">
                        <div className="mb-2 text-6xl font-light md:text-7xl">100<span className="text-[#D4AF37]">+</span></div>
                        <p className="text-sm uppercase tracking-widest text-neutral-400">Projects Completed</p>
                    </div>
                    <div className="border-r border-white/20 last:border-0 md:px-12">
                        <div className="mb-2 text-6xl font-light md:text-7xl">230<span className="text-[#D4AF37]">+</span></div>
                        <p className="text-sm uppercase tracking-widest text-neutral-400">Happy Clients</p>
                    </div>
                    <div className="border-r border-white/20 last:border-0 md:px-12">
                        <div className="mb-2 text-6xl font-light md:text-7xl">25<span className="text-[#D4AF37]">+</span></div>
