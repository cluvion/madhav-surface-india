            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute -bottom-8 -left-8 bg-foreground p-6 text-white">
                        ...
                        <div className="divide-y divide-neutral-200 border-t border-neutral-200">
                            {awards.map((award, index) => (
                                <div key={index} className="group flex items-center justify-between py-6 transition-colors hover:bg-neutral-50">
                                    ...
                                    <span className="text-sm font-bold text-neutral-400 group-hover:text-foreground">{award.year}</span>
                                </div>
                            ))}
                        </div>
                    </div>
