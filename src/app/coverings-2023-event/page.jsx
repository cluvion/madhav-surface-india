            ...
            <Section>
                ...
                <div className="text-center md:text-left">
                    ...
                    <h2 className="text-[1.6rem] md:text-[4rem] leading-[1.1] font-bold text-black max-w-5xl">
                        Madhav Surfaces Gears Up for Coverings 2023,
                    ...
                    <div className="flex flex-col space-y-4 mt-8 text-foreground/50 text-sm md:text-base leading-relaxed text-justify">
                        ...
                        <h3 className="text-xl md:text-2xl font-bold text-black pt-4">Are You Attending Coverings?</h3>
                        ...
                        <h3 className="text-xl md:text-2xl font-bold text-black pt-4">Madhav Marbles to Unveil Major Announcements During Coverings 2023</h3>
